...
public class LoginPageElements {
    ...
    public static Target CLOSE_BTN = Target.the("Close Button").located(By.id("android:id/button3"));

    public static Target PAYMENT_BUTTON = Target.the("Payment Button").located(By.id("mortageRequestButton"));
